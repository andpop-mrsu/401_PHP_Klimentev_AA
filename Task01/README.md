...
```bash
composer require AlexeyKlimentev/gcd
```
...
**AlexeyKlimentev**  
GitHub: `AlexeyKlimentev`

--- 

## Проект на Packagist [https://packagist.org/packages/AlexeyKlimentev/gcd](https://packagist.org/packages/AlexeyKlimentev/gcd) 